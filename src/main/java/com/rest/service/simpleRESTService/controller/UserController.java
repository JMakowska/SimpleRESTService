...
public class UserController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "User you were trying to reach is not found", response = ErrorResponseDTO.class)
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "User doesn't exist in database", response = ErrorResponseDTO.class)
    })
